...
<BODY>
    ...
    ?>
    <br>
    <a href="select.php">Wyślij muzykę</a><br>
    <a href="playlists.php">Tworzenie playlisty i dodawanie utworów</a><br>
    <?php
    ...
    $result = mysqli_query($connection, "Select * from song ORDER BY datetime DESC LIMIT 5 ") or die("DB error: $dbname");
    print "Ostatnio dodane 5 utworów.<br>";
